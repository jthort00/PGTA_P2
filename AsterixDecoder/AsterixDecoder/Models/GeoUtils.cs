...
namespace MultiCAT6.Utils
{
    ...
    public class GeoUtils
    {
        ...
        /// <summary>
        /// converts latitude or longitude expressed as gg�mm'ss,ss'' X to degrees dd,dddd�
        /// </summary>
        ...
        /// <summary>
        /// converts latitude or longitude expressed as gg�mm'ss,ss'' X to radians dd,ddddr
        /// </summary>
        /// <param name="d1">degree</param>
        /// <param name="d2">minutes</param>
        /// <param name="d3">seconds</param>
        ...
        /// <summary>
        /// converts latitude or longitude expressed as gg�mm'ss,ss'' X in a string to degrees dd,dddd�
        /// </summary>
        ...
        /// <summary>
        /// converts degrees dd,ddddd to latitude or longitude expressed as gg�mm'ss,ss'' X 
        /// </summary>
        ...
        /// <summary>
        /// converts radians dd,ddddd to latitude or longitude expressed as gg�mm'ss,ss'' X 
        /// </summary>
    ...
    public class CoordinatesPolar : Coordinates
    {
        ...
        {
            System.Text.StringBuilder s = new System.Text.StringBuilder();
            s.AppendFormat(" R: {0:f4}NM T: {1:f4}� E: {2:f4}�", c.Rho * GeoUtils.METERS2NM, c.Theta * GeoUtils.RADS2DEGS, c.Elevation * GeoUtils.RADS2DEGS);
            return s.ToString();
        }
    }
    /// <summary>
    ...
    public class CoordinatesWGS84 : Coordinates
    {
        ...
        public override string ToString()
        {
            ...
            //s.AppendFormat("{0:d2}�{1:d2}'{2:f4}" + (n == 0 ? 'E' : 'W') + " ", (int)d1, (int)d2, d3);
